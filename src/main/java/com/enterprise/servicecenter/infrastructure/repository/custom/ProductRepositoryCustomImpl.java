...
public class ProductRepositoryCustomImpl implements ProductRepositoryCustom {
    ...
    @Override
    public List<ProductForInventoryProjection> searchProductsForInventory(String text, int page, int size) {
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<ProductForInventoryProjection> cq = cb.createQuery(ProductForInventoryProjection.class);
        ...
        cq.select(cb.construct(
                ProductForInventoryProjection.class,
                productRoot.get("id"),
                productPackageRoot.get("id"),
                productRoot.get("name"),
                productPackageRoot.get("codedName"),
